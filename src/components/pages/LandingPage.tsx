    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-6 py-12">
      ...
      <div className="relative z-10 max-w-2xl text-center space-y-8">
        ...
        >
          ...
          <div className="flex items-center justify-center gap-4 text-2xl font-semibold text-blue-300">
            <span>Ξ</span>
        ...
        <motion.div
          ...
          className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-gray-400 max-w-3xl mx-auto"
        >
          <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10">
            <div className="text-2xl mb-2">⚡</div>
            <div className="font-semibold text-white mb-1">Real-Time Racing</div>
            <div>Tap to move your team forward</div>
          </div>
          <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10">
            <div className="text-2xl mb-2">💰</div>
            <div className="font-semibold text-white mb-1">Stake & Earn</div>
            <div>Winners split the prize pool</div>
          </div>
          <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10">
            <div className="text-2xl mb-2">🏆</div>
            <div className="font-semibold text-white mb-1">Fair Rewards</div>
            <div>Proportional to your taps</div>
          </div>
        </motion.div>
        ...
        >
          {connectors.slice(1).map((connector) => (
            <button
              ...
              className="w-full max-w-md mx-auto block px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-bold text-lg rounded-2xl transition-all transform hover:scale-105 active:scale-95 shadow-2xl shadow-blue-500/50"
            >
